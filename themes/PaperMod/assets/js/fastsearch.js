...
//Code for the Toggle Feature in the Markdown.

// Get all the markdown elements that contain the details tag
const markdownDetails = document.querySelectorAll("markdown details");

// Loop through each markdown details element
markdownDetails.forEach((details) => {
  // Hide the inner content initially
  details.querySelector("summary").addEventListener("click", () => {
    details.querySelector("div").classList.toggle("hide");
  });
});
